...
if (isset($_POST['update'])) {
   ...
   $price = $_POST['price'];
   $places = $_POST['places'];  // Keep as string
   $days = $_POST['days'];
   ...
   if ($stmt) {
       $stmt->bind_param("ssssssi", $type, $location, $details, $price, $places, $days, $id);  // Changed "i" to "s" for places
       if ($stmt->execute()) {
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button class='view-desc-btn' data-details='" . htmlspecialchars($row['details'], ENT_QUOTES) . "'>View</button></td>";
                    ...
                    echo "<button class='edit-btn' 
                            ...
                            data-details='{$row['details']}'>Edit</button>";
...
<div class="popup" id="editPopup">
    <div class="content">
        ...
        <form method="POST">
            ...
            <label>Days:</label>
            <input type="number" name="days" id="editDays" required>
            <label>Price:</label>
