...
<section class="booking">
   ...
   <form action="book_form.php" method="post" class="book-form">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Arrivals:</span>
            <input type="date" id="arrivals" name="arrivals" value="<?php echo htmlspecialchars($startDate); ?>" required>
         </div>
         <div class="inputBox">
            <span>Leaving:</span>
            <input type="date" id="leaving" name="leaving" value="<?php echo htmlspecialchars($endDate); ?>" required oninput="validateDates()">
         ...
         <div class="inputBox">
            ...
            <input type="text" id="vehicle" name="vehicle" value="<?php echo htmlspecialchars($vehicle); ?>" required>
         </div>
         <div class="inputBox">
            <span>Hotel Class:</span>
            <input type="text" id="hotel" name="hotel" value="<?php echo htmlspecialchars($hotel); ?>" required>
         </div>
         <div class="inputBox">
            <span>Menu Type:</span>
            <input type="text" id="menu" name="menu" value="<?php echo htmlspecialchars($menu); ?>" required>
         </div>
      </div>
